          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3 mt-8">
              {highlights.map((highlight, index) => (
                <div
                  key={highlight}
                  className="flex items-center space-x-2 p-3 bg-gray-700/50 rounded-lg border border-cyan-500/20 hover:border-cyan-500/40 transition-colors duration-200"
                >
            ...
            <div className="bg-gradient-to-br from-cyan-500/20 to-cyan-600/20 rounded-2xl p-8 border border-cyan-500/30">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center p-4 bg-gray-700/50 rounded-lg">
                  ...
                  <p className="text-gray-400 text-sm">Penetration</p>
                </div>
                <div className="text-center p-4 bg-gray-700/50 rounded-lg">
                  <Database className="h-12 w-12 text-cyan-400 mx-auto mb-3" />
                  <h3 className="text-white font-semibold">Research</h3>
